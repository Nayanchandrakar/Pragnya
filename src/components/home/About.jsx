...
Than Digital platform list same as dignity of noble digital platforms,Create in card form.
                "
      />
      <div className="rounded-xl  bg-heading/[.1] backdrop-blur-2xl w-full h-full">
        ...
        {/* first div */}
        <div className="flex z-10 relative flex-row justify-between items-center gap-4 sm:gap-0 px-8 sm:px-12 py-8  border-b-[3px] border-borderColor md:py-4">
          <span className="flex flex-col items-center sm:items-start">
            <strong className="text-[5vw] xl:text-[4rem] text-heading font-Poppins font-extrabold">
              1.5K+
            </strong>
            <strong className="text-heading text-sm font-bold sm:text-lg ">
              Collections
            </strong>
          </span>
          <span className="flex flex-col items-center sm:items-start">
        ...
        <div className="w-full z-10 relative h-full px-12 md:inline-block hidden ">
          <div className="grid grid-cols-3 gap-8">
            <span className="flex flex-col justify-start gap-4 border-r-[3px] border-borderColor py-14 pr-8">
              <MdSecurity size={50} color="#76b0bf" />
              <span className="text-heading">
                <strong className="text-[3vw] sm:text-[1.5vw] text-heading font-bold uppercase">
                  Strong security
                </strong>
            ...
            <span className="flex flex-col justify-start gap-4 border-r-[3px] border-borderColor py-14 pr-8">
              ...
              <span className="text-heading">
                ...
                <p className="text-sm text-para">
                  Flexible payment of methods wiht Visa,Mastercard, Paypal,bank
                  transfer
                </p>
              </span>
            </span>
            <span className="flex flex-col justify-start gap-4 py-14">
              ...
              <span className="text-heading">
                ...
                <p className="text-sm text-para">
                  The most accurate and trusted source for market cap,
                  valuation, and cryptocurrency information
                </p>
              </span>
            </span>
          </div>
